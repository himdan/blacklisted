...
class __TwigTemplate_cabffb3c97f64ab3677b06906e43ef89b2e5b4a8569e12dc2c2b1c253dc3f180 extends Twig_Template
{
    private $source;
...
";
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["trace"] ?? null), "file", [], "any", true, true) && twig_get_attribute($this->env, $this->source, ($context["trace"] ?? null), "line", [], "any", true, true))) {
            // line 7
            echo "        in ";
            echo twig_get_attribute($this->env, $this->source, (isset($context["trace"]) || array_key_exists("trace", $context) ? $context["trace"] : (function () { throw new Twig_Error_Runtime('Variable "trace" does not exist.', 7, $this->source); })()), "file", []);
            echo " line ";
            echo twig_get_attribute($this->env, $this->source, (isset($context["trace"]) || array_key_exists("trace", $context) ? $context["trace"] : (function () { throw new Twig_Error_Runtime('Variable "trace" does not exist.', 7, $this->source); })()), "line", []);
            echo "
";
        }
...
{% endif %}
", "@Twig/Exception/trace.txt.twig", "/home/mohamed/PhpstormProjects/Quickstart3/symfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/trace.txt.twig");
    }
}
