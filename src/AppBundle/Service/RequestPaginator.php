...
class RequestPaginator extends Paginator
{
    ...
    {
        $result = parent::paginate($metaClassName, $filters, $getObj, $injectFilter, $orderSet); // TODO: Change the autogenerated stub
        $result['data'] = $this->serializer->serialize($result['data'], 'json');
        return $result;
    }
